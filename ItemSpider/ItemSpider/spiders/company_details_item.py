...
class CompanyDetailsItemSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        company_price_intraday_list = response.xpath('//*[@id="scr-res-table"]/div[1]/table/tbody/tr/td[3]/span/text()').extract()
        company_symbol_list = response.xpath('//*[@id="scr-res-table"]/div[1]/table/tbody/tr/td[1]/a/text()').extract()
        company_symbol_link_list = response.xpath('//*[@id="scr-res-table"]/div[1]/table/tbody/tr/td[1]/a/@href').extract()
